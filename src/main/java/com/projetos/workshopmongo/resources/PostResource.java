...
import com.projetos.workshopmongo.resources.util.URL;
import com.projetos.workshopmongo.services.PostService;

@RestController // Recurso Rest
@RequestMapping(value = "/posts") // Caminho da endpoint
